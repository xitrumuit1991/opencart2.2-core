...
$_['text_success']                            = 'Hoàn tất: Bạn đã thay đổi các thiết lập FraudLabs Pro!';
$_['text_edit']                               = 'Thiết lập';
$_['text_signup']                             = 'FraudLabs Pro là một dịch vụ phát hiện gian lận. Bạn có thể đăng ký miễn phí <a href="http://www.fraudlabspro.com/plan?ref=1730" target="_blank"><u>tại đây</u></a> và nhận mã khóa API miễn phí.';
$_['text_id']                                 = 'FraudLabs Pro ID';
$_['text_ip_address']                         = 'Địa chỉ IP';
$_['text_ip_net_speed']                       = 'IP Net Speed';
$_['text_ip_isp_name']                        = 'IP Nhà cung cung cấp (ISP)';
$_['text_ip_usage_type']                      = 'IP Usage Type';
$_['text_ip_domain']                          = 'IP Tên miền';
$_['text_ip_time_zone']                       = 'IP Múi giờ';
$_['text_ip_location']                        = 'IP Khu vực';
$_['text_ip_distance']                        = 'IP Distance';
$_['text_ip_latitude']                        = 'IP Vĩ độ';
$_['text_ip_longitude']                       = 'IP Kinh độ';
$_['text_risk_country']                       = 'Quốc gia tiềm ẩn nguy cơ';
...
$_['entry_key']                               = 'Mã khóa API';
$_['entry_score']                             = 'Điểm nguy cơ';
$_['entry_order_status']                      = 'Trạng thái đơn hàng';
$_['entry_review_status']                     = 'Trạng thái đánh giá';
$_['entry_approve_status']                    = 'Trạng thái chấp nhận';
$_['entry_reject_status']                     = 'Trạng thái từ chối';
$_['entry_simulate_ip']                       = 'IP mô phỏng';

// Help
$_['help_order_status']                       = 'Đơn đặt hàng có một số điểm bằng thang điểm nguy cơ trở lên sẽ được chỉ định trạng tháinày.';
$_['help_review_status']                      = 'Đơn đặt hàng mà FraudLabs Pro đánh dấu là xem xét lại sẽ được chỉ định trạng thái này.';
$_['help_approve_status']                     = 'Đơn đặt hàng được FraudLabs Pro đánh dấu an toàn sẽ được chỉ định trạng thái này.';
$_['help_reject_status']                      = 'Đơn đặt hàng  bị FraudLabs Pro từ chối sẽ được chỉ định trạng thái này.';
$_['help_simulate_ip']                        = 'Mô phỏng các địa chỉ IP của khách truy cập  để thử nghiệm. Để trống để vô hiệu hóa nó.';
...
$_['help_score']                              = 'Điểm nguy cơ, 0 (thấp nhất) - 100 (cao nhất).';
...
// Error
$_['error_permission']                        = 'Cảnh báo: Bạn không đủ quyền hạn sửa đổi các thiết lập của FraudLabs Pro!';
$_['error_key']		                            = 'Thiếu mã khóa API!';