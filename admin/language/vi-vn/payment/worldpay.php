...
$_['text_successful']    = 'On - Luôn thành công';
$_['text_declined']      = 'On - Luôn từ chối';
$_['text_off']           = 'Off';
      
// Entry
$_['entry_merchant']     = 'Merchant ID:';
$_['entry_password']     = 'Mật khẩu đáp ứng thanh toán:<br /><span class="help">Điều này đã được thiết lập trong bảng điều khiển WordPay.</span>';
$_['entry_callback']     = 'Relay Response URL:<br /><span class="help">Điều này đã được thiết lập trong bảng điều khiển WordPay . Bạn cũng sẽ cần phải kiểm tra "Enable the Shopper Response".</span>';
